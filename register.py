...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file="bg\\p2.jpg",master=root)
        bg=Label(self.root,image=self.bg).place(x=0,y=0,relwidth=1,relheight=1)
        
        frame1=Frame(self.root,bg="black")
        frame1.place(x=350,y=100,width=700,height=500)
        
        title=Label(frame1,text="REGISTER HERE",font=("times new roman",20,"bold"),bg="black",fg="#1ebbb0").place(x=50,y=40)
        
        fname=Label(frame1,text="First name",font=("times new roman",15,"bold"),bg="black",fg="gray").place(x=50,y=100)
        self.txt_fname=Entry(frame1,font=("times new roman",15),bg="lightgray")
        self.txt_fname.place(x=50,y=130,width=250)
        
        Lname=Label(frame1,text="Last name",font=("times new roman",15,"bold"),bg="black",fg="gray").place(x=370,y=100)
        self.txt_Lname=Entry(frame1,font=("times new roman",15),bg="lightgray")
        self.txt_Lname.place(x=370,y=130,width=250) 
        
        contact=Label(frame1,text="Phone number",font=("times new roman",15,"bold"),bg="black",fg="gray").place(x=50,y=170)
        ...
        password=Label(frame1,text="Password",font=("times new roman",15,"bold"),bg="black",fg="gray").place(x=50,y=240)
        self.txt_password=Entry(frame1,show="*",font=("times new roman",15),bg="lightgray")
        self.txt_password.place(x=50,y=270,width=250)
        
        cpass=Label(frame1,text="Confirm password",font=("times new roman",15,"bold"),bg="black",fg="gray").place(x=370,y=240)
        self.txt_cpass=Entry(frame1,show="*",font=("times new roman",15),bg="lightgray")
        self.txt_cpass.place(x=370,y=270,width=250)
        
        
     
        btn_register=Button(frame1,text="REGISTER NOW",font=("times new roman",15,"bold"),bg="#1ebbb0",fg="white",command=self.register_data).place(x=50,y=320)
        btn_reg=Button(frame1,text="BACK TO LOGIN ",command=self.register_window,font=("times new roman",10),bg="black",bd=0,fg="gray").place(x=50,y=365)
    ...
    def register_data(self):
        ...
        if flag==0:
            try:
                con=pymysql.connect(host="localhost",user="root",password="Kamatchi*2630",database="abhinaya")
                cur=con.cursor()
